(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/component/GameMap.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '37c7fXitoxJeLifhTgrHNC8', 'GameMap', __filename);
// scripts/component/GameMap.js
...
cc.Class({
    ...
    createGrid: function createGrid(rowKey, colKey) {
    ...
    addToGrid: function addToGrid(rowKey, colKey, matType) {
    ...
    removeFromGrid: function removeFromGrid(rowKey, colKey, matType) {
        var grid = this.node.getChildByName(rowKey + "_" + colKey);
        if (grid) {
    ...
    removeAllFromGrid: function removeAllFromGrid(rowKey, colKey, matType) {
        var grid = this.node.getChildByName(rowKey + "_" + colKey);
        if (grid) {
            var children = grid.children;
    ...
    mouseMoveHandle: function mouseMoveHandle(event) {
        if (!this.curPassData.configData.mapInfo.isDrag) return;
