(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/ResMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '033c8HLwuNAsLgqb7hZ4puu', 'ResMgr', __filename);
// scripts/ResMgr.js
...
cc.Class({
    ...
    loadTempRes: function loadTempRes(resNameVal, onFinished) {
    ...
    loadRes: function loadRes(resNameVal, onFinished) {
    ...
    //加载没有uuid的资源文件
    loadEditorRes: function loadEditorRes(url, onFinished) {
